...
public class ModRecipes {
	...
	public static void addRecipes() {
    	...
    	addCompressionRecipe(ModBlocks.OctupleCompressedFlint,ModBlocks.SeptupleCompressedFlint);
    	addCompressionRecipe(ModBlocks.SeptupleCompressedFlint,ModBlocks.SextupleCompressedFlint);
    	addCompressionRecipe(ModBlocks.SextupleCompressedFlint,ModBlocks.QuintupleCompressedFlint);
    	addCompressionRecipe(ModBlocks.QuintupleCompressedFlint,ModBlocks.QuadrupleCompressedFlint);
    	addCompressionRecipe(ModBlocks.QuadrupleCompressedFlint,ModBlocks.TripleCompressedFlint);
    	addCompressionRecipe(ModBlocks.TripleCompressedFlint,ModBlocks.DoubleCompressedFlint);
    	addCompressionRecipe(ModBlocks.DoubleCompressedFlint,ModBlocks.CompressedFlint);
