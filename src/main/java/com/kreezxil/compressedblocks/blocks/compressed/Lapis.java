...
public class Lapis extends Block implements IMetaBlockName {
	// previously there was no implements
	public static String harvestTool = "pickaxe";
	public static int MAXTIER = 8;
	public static String UnlocalizedName = "CompressedLapis";
	public static float baseHardness = 3f;
	public static float hardnessFactor = 0.51f;
	public static float explosionFactor = 0.0378f;
	public static int WOOD = 0;
	public static int STONE = 1;
	public static int IRON = 2;
	public static int DIAMOND = 3;
	public static int[] harvestLevel = { STONE, STONE, STONE, IRON, IRON, IRON,
			DIAMOND, DIAMOND };
	...
	public Item getItemDropped(IBlockState state, Random par2Random, int par3) {
		...
		int tier = stateTier.getID();
		if (tier > 0 && tier < MAXTIER) {
			return Item.getItemFromBlock(ModBlocks.CompressedLapis);
		}
