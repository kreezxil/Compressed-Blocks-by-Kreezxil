...
public class Emerald extends Block implements IMetaBlockName {
	// previously there was no implements
	public static String harvestTool = "pickaxe";
	public static int MAXTIER = 8;
	public static String UnlocalizedName = "CompressedEmerald";
	public static float baseHardness = 10f;
	public static float hardnessFactor = 0.8f;
	public static float explosionFactor = 0.275f;
	public static int WOOD = 0;
	public static int STONE = 1;
	public static int IRON = 2;
	public static int DIAMOND = 3;
	public static int[] harvestLevel = { DIAMOND, DIAMOND, DIAMOND, DIAMOND, DIAMOND, DIAMOND, DIAMOND, DIAMOND };
	...
	public Emerald() {
		super(Material.rock);
		this.setDefaultState(this.blockState.getBaseState().withProperty(TIER, EnumTier.COMPRESSED));
	...
	public Item getItemDropped(IBlockState state, Random par2Random, int par3) {
		...
		int tier = stateTier.getID();
		if (tier > 0 && tier < MAXTIER) {
			return Item.getItemFromBlock(ModBlocks.CompressedEmerald);
		}
