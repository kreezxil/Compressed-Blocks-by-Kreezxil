...
public class Iron extends Block implements IMetaBlockName {
	// previously there was no implements
	public static String harvestTool = "pickaxe";
	public static int MAXTIER = 8;
	public static String UnlocalizedName = "CompressedIron";
	public static float baseHardness = 7f;
	public static float hardnessFactor = 0.734f;
	public static float explosionFactor = 0.234f;
	...
	public Item getItemDropped(IBlockState state, Random par2Random, int par3) {
		...
		int tier = stateTier.getID();
		if (tier > 0 && tier < MAXTIER) {
			return Item.getItemFromBlock(ModBlocks.CompressedIron);
		}
