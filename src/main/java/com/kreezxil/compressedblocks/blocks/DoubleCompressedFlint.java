...
public class DoubleCompressedFlint  extends Block {

	public DoubleCompressedFlint(String unlocalizedName, Material materialIn, float hardness, float resistance) {
		super(materialIn);
	...
	public DoubleCompressedFlint(String name, float hardness, float resistance) {
		this(name, Material.rock, hardness, resistance);
	}
	
	public DoubleCompressedFlint(String name) {
		this(name,20f, 4f);
	}
