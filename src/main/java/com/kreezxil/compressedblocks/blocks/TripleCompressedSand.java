...
public class TripleCompressedSand  extends Block {
	...
	public TripleCompressedSand(String unlocalizedName, Material materialIn, float hardness, float resistance) {
		super(materialIn);
	...
	public TripleCompressedSand(String name, float hardness, float resistance) {
		this(name, Material.rock, hardness, resistance);
	}
	
	public TripleCompressedSand(String name) {
		this(name, 20f, 100f);
	}
	...
	public Item getItemDropped(IBlockState state, Random par2Random, int par3){
		return Item.getItemFromBlock(ModBlocks.DoubleCompressedSand);
	}
