...
public class DoubleCompressedCoalBlock  extends Block {

	public DoubleCompressedCoalBlock(String unlocalizedName, Material materialIn, float hardness, float resistance) {
		super(materialIn);
	...
	public DoubleCompressedCoalBlock(String name, float hardness, float resistance) {
		this(name, Material.rock, hardness, resistance);
	}
	
	public DoubleCompressedCoalBlock(String name) {
		this(name,16f, 20f);
	}
