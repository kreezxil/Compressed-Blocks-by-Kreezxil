...
public class CompressedCoalBlock extends Block {
	...
	public CompressedCoalBlock(String unlocalizedName, Material materialIn, float hardness, float resistance) {
		super(materialIn);
	...
	public CompressedCoalBlock(String name, float hardness, float resistance) {
		this(name, Material.rock, hardness, resistance);
	}
	
	public CompressedCoalBlock(String name) {
		this(name, 8f, 10f);
	}
