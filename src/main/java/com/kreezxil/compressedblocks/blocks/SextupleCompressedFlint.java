...
public class SextupleCompressedFlint  extends Block {

	public SextupleCompressedFlint(String unlocalizedName, Material materialIn, float hardness, float resistance) {
		super(materialIn);
	...
	public SextupleCompressedFlint(String name, float hardness, float resistance) {
		this(name, Material.rock, hardness, resistance);
	}
	
	public SextupleCompressedFlint(String name) {
		this(name,320f, 64f);
	}
