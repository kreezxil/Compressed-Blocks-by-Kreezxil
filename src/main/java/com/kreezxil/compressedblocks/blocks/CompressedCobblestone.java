...
public class CompressedCobblestone extends Block{
	...
	public CompressedCobblestone(String unlocalizedName, Material materialIn, float hardness, float resistance) {
		super(materialIn);
	...
	public CompressedCobblestone(String name, float hardness, float resistance) {
		this(name, Material.rock, hardness, resistance);
	}
	
	public CompressedCobblestone(String name) {
		this(name,4f, 60f);
	}
