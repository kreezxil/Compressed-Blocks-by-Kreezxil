...
public class SeptupleCompressedFlint  extends Block {

	public SeptupleCompressedFlint(String unlocalizedName, Material materialIn, float hardness, float resistance) {
		super(materialIn);
	...
	public SeptupleCompressedFlint(String name, float hardness, float resistance) {
		this(name, Material.rock, hardness, resistance);
	}
	
	public SeptupleCompressedFlint(String name) {
		this(name,640f, 128f);
	}
