...
public class DoubleCompressedDirt  extends Block {
	...
	public DoubleCompressedDirt(String unlocalizedName, Material materialIn, float hardness, float resistance) {
		super(materialIn);
	...
	public DoubleCompressedDirt(String name, float hardness, float resistance) {
		this(name, Material.rock, hardness, resistance);
	}
	
	public DoubleCompressedDirt(String name) {
		this(name, 6f, 14f);
	}
