...
public class CompressedDirt extends Block {
	...
	public CompressedDirt(String unlocalizedName, Material materialIn, float hardness, float resistance) {
		super(materialIn);
	...
	public CompressedDirt(String name, float hardness, float resistance) {
		this(name, Material.rock, hardness, resistance);
	}
	
	public CompressedDirt(String name) {
		this(name, 4f, 12f);
	}
